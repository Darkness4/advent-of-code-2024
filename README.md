...
```shell
zig() {
  docker run --ulimit=host --rm -it -v $(pwd):/work -w /work ghcr.io/darkness4/aoc-2024:base "$@"
}
zig build <dayX>
```
...
day18 p1               15       1.1s           73.379ms ± 2.213ms     (70.839ms ... 79.203ms)      74.892ms   79.203ms   79.203ms
day18 p1 [MEMORY]                              509.211KiB ± 0B        (509.211KiB ... 509.211KiB)  509.211KiB 509.211KiB 509.211KiB
day18 p2               63       1.75s          27.778ms ± 581.294us   (26.917ms ... 29.57ms)       27.91ms    29.57ms    29.57ms
day18 p2 [MEMORY]                              252.531KiB ± 0B        (252.531KiB ... 252.531KiB)  252.531KiB 252.531KiB 252.531KiB

day19 p1               63       1.197s         19.014ms ± 794.264us   (18.146ms ... 22.729ms)      19.527ms   22.729ms   22.729ms
day19 p1 [MEMORY]                              216.047KiB ± 0B        (216.047KiB ... 216.047KiB)  216.047KiB 216.047KiB 216.047KiB
day19 p2               15       1.786s         119.114ms ± 1.914ms    (117.341ms ... 124.582ms)    120.523ms  124.582ms  124.582ms
day19 p2 [MEMORY]                              600.047KiB ± 0B        (600.047KiB ... 600.047KiB)  600.047KiB 600.047KiB 600.047KiB

day20 p1               7        1.685s         240.726ms ± 6.268ms    (234.667ms ... 252.922ms)    243.771ms  252.922ms  252.922ms
day20 p1 [MEMORY]                              401.602KiB ± 0B        (401.602KiB ... 401.602KiB)  401.602KiB 401.602KiB 401.602KiB
day20 p2               7        1.652s         236.127ms ± 1.795ms    (233.837ms ... 239.167ms)    237.109ms  239.167ms  239.167ms
day20 p2 [MEMORY]                              401.602KiB ± 0B        (401.602KiB ... 401.602KiB)  401.602KiB 401.602KiB 401.602KiB
```
